 ...
 * resolve method we've got result of ClientResponseHandler
 * and reject methods will be contained the same exceptions
 */
interface AsyncClientResponseHandlerInterface
{
    /**
